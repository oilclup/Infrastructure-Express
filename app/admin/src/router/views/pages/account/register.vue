    ...
    tryToRegisterIn() {
      ...
      return this.register({
        ...
        .catch((error) => {
          ...
          this.regError = error.response.data.errors
            ? error.response.data.errors[0].password
            : error.response.data.error.message

          alert(this.regError)
          // this.regError = error.response.data.errors[0].password
          // alert(this.regError)
        })
    },
  },
              ...
              <div class="card-body p-0">
                <div class="row">
                  <div class="col-lg-6 p-5">
                    ...
                    <form action="#" class="authentication-form" @submit.prevent="tryToRegisterIn">
            ...
            <div class="row mt-3">
              <div class="col-12 text-center">
                <p class="text-muted">
                  ...
                  <router-link tag="a" to="/login" class="text-primary font-weight-bold ml-1">Log In</router-link>
                </p>
              </div>
              <!-- end col -->
            </div>
